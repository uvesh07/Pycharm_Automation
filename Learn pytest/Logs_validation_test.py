...
class Testing(unittest.TestCase):
    ...
    def test_date_log(self):
        ...
        sel.select_by_visible_text("Krimit Shah")
    ...
    def test_search_by_date(self):
        ...
        if flag == 0:
            ...
            print(f"The employee worked {extra_hrs} hour and {total_min} minutes extra on {Expected_date}")
...
if __name__ == "__main__":
    ...
    suite.addTest(loader.loadTestsFromTestCase('test_logs'))
    suite.addTest(loader.loadTestsFromTestCase('test_date_log'))
    suite.addTest(loader.loadTestsFromTestCase('test_search_by_date'))
